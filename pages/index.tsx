...
export default function Home() {
  return (
    <Layout>
      <div className='flex justify-center items-center h-[calc(100vh-72px)] w-screen'>
        {/* Background Image */}
        <Image
          ...
          height={1843}
          loading={'lazy'}
          className='-z-[2] h-[calc(100vh-72px)] w-full object-cover absolute'
        />
        {/* Overlay */}
        <div className='-z-[1] h-[calc(100vh-72px)] w-full bg-gradient-to-b from-black via-black to-transparent absolute'></div>
        {/* Content */}
