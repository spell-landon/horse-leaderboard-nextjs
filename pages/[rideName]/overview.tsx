...
const Overview = () => {
  ...
  return (
    <div className='w-full bg-black/5 h-full'>
      {/* Header */}
      <div className='bg-white border border-b-black/10 shadow-sm px-4 lg:px-0 py-8'>
        <div className='w-full max-w-5xl mx-auto flex justify-between items-center'>
          ...
          {/* Edit Ride Button */}
          <Link
            href='/bell-cow-rendezvous/edit'
            className='text-black/50 bg-transparent rounded-md shadow-md py-3 px-6 hover:bg-black/5 border border-black/50'>
            Edit Ride
          </Link>
        </div>
      </div>
